...
conf.get_default().auth_token = "2ypuNZDv12fNqgVqp1pUnqM29TG_7xhaDBaKqv7bKHX9yC9Q9"
...
<!DOCTYPE html>
<html>
<head><title>English Accent Classifier 🎙️🌍</title></head>
<body>
    <h2>🎙️🌍 English Accent Classifier</h2>
    <p>Upload a video link (e.g. YouTube, Loom, etc.) and get accent prediction.</p>

    <form method="post">
        <label>Enter public video URL:</label><br>
        <input type="text" name="url" required style="width: 400px;"><br><br>

        <label>Ask something about the audio:</label><br>
        <input type="text" name="query" placeholder="e.g. Summarize or What is being discussed?" style="width: 400px;"><br><br>
...
print("🚀 Open this public URL:", public_url)
